...
3install.packages("ggpointdensity", repos = "https://cloud.r-project.org/", dependencies=TRUE)
...
3install.packages("KernSmooth", repos = "https://cloud.r-project.org/", dependencies=TRUE)
